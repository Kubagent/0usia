...
// import Lenis from 'lenis'; // Disabled to prevent build issues
...
export default function usePerformantSectionSnap({
  ...
  // Lenis disabled - this is a stub function for now
  console.warn('Performant section snap disabled - Lenis import commented out');
  return;
  
  /* Lenis functionality disabled
